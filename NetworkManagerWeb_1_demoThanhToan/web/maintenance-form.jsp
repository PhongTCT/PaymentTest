...
<div class="page-wrapper">
    ...
    <div class="page-header">
        <div class="page-title-group">
            ...
            <div>
                <h1 class="page-title">Schedule Maintenance</h1>
                <p class="page-subtitle">Create a new planned maintenance task for network devices</p>
            </div>
        </div>
    </div>
    ...
    <div class="form-card">
        <form action="MainController" method="post" id="maintenanceForm">
            <input type="hidden" name="action" value="maintenanceInsert">
            
            <div class="mb-4">
                <label class="form-label">Task Title <span class="text-danger">*</span></label>
                <input type="text" class="form-control" name="title" placeholder="e.g., Firmware Upgrade Floor 2" required>
            </div>

            <div class="mb-4">
                <label class="form-label">Description</label>
                <textarea class="form-control" name="description" rows="3" placeholder="Provide details about the maintenance task..."></textarea>
            </div>
            ...
            <div class="form-actions">
                <a href="maintenance-list.jsp" class="btn-dash btn-dash-ghost">Cancel</a>
