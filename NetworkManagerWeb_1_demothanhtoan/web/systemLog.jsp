                                                ...
                                                <div class="section-card">
                                                    <div class="section-card-header">
                                                        ...
                                                        <div class="pagination-controls">
                                                            <button class="page-btn" onclick="prevPage('systemLog-table')" id="systemLog-table-prev"><i class="bi bi-chevron-left"></i></button>
                                                            <span class="page-info" id="systemLog-table-page-info">Page 1 of 1</span>
                                                            <button class="page-btn" onclick="nextPage('systemLog-table')" id="systemLog-table-next"><i class="bi bi-chevron-right"></i></button>
                                                        </div>
                                                    </div>
                                                    <div class="section-card-body">
                                                        <div class="table-responsive">
                                                            <table class="table-dark-custom" id="systemLog-table">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Log ID</th>
                                                                        <th>Action</th>
                ...
                <form action="UserController" method="POST">
                    ...
                    <script>
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            initPagination('systemLog-table');
